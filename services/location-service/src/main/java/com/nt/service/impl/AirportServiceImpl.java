...
import com.nt.mapper.AirportMapper;
import com.nt.model.Airport;
import com.nt.model.City;
import com.nt.payload.request.AirportRequest;
import com.nt.payload.response.AirportResponse;
import com.nt.repository.AirportRepository;
import com.nt.repository.CityRepository;
import com.nt.service.AirportService;
...
public class AirportServiceImpl implements AirportService {
    ...
    public AirportResponse updateAirport(Long id, AirportRequest request) throws Exception {
        Airport existingAirport = airportRepository.findById(id).orElseThrow(
                ()-> new Exception("airport not exits with id "+id)
        );
